...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "applicants", name = "Applicants", hidden = false)
public class ApplicantsModel implements org.kie.kogito.Model {
    ...
    public ApplicantsModelOutput toOutput() {
        ApplicantsModelOutput result = new ApplicantsModelOutput();
        result.setId(getId());
        result.setApplicant(getApplicant());
        result.setIsApproved(getIsApproved());
        return result;
    }
}
